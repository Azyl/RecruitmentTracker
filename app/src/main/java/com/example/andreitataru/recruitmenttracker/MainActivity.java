 ...
 ////////
    ...
    public void LoginFunction(){
        ...
        if(EditTextEmptyHolder) {
            ...
            //sqLiteDatabaseObj = sqLiteHelper.getWritableDatabase(); mdb
            ...
            while (cursor.moveToNext()) {
                ...
                if (cursor.isFirst()) {
                    ...
                    TempPassword = cursor.getString(cursor.getColumnIndex(DatabaseContracts.User.Table_Column_3_Password));
